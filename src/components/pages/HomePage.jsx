...
// Página Inicial (Home)
// Carrega e exibe as últimas notícias, recados e eventos
const HomePage = ({ navigate }) => {
  // Hooks personalizados para buscar dados de diferentes endpoints
  const {
    data: news,
    loading: newsLoading,
    error: newsError,
  ...
  // Função auxiliar para pegar apenas os 4 primeiros itens (mais recentes)
  ...
  return (
    <div className="relative min-h-screen bg-gray-50">
      {/* Hero Section (Banner Grande com Foto) */}
      <div className="relative w-full h-96 lg:h-[600px] flex items-center justify-center overflow-hidden">
        ...
        />
        {/* Degradê escuro sobre a foto para melhorar leitura do texto */}
          ...
          {(recentNews.length > 0 || newsLoading || newsError) && (
            <section className="bg-white p-6 md:p-8 rounded-2xl shadow-xl border-t-4 border-blue-500 animate-slide-in-up">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {/* Exibe Skeletons (carregando), Erro ou os Cards de Notícia */}
                {newsLoading ? (
